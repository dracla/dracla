...
class TestEventPreconditions(unittest.TestCase):
    ...
    def test_reader_materialization_authority_binds_rule_subject_and_presence(self):
        ...
        with self.subTest(mutation="same-shard-rule"), self.assertRaises(PreconditionValidationError):
        ...
        with self.subTest(mutation="different-subject"), self.assertRaises(PreconditionValidationError):
