...
| M1-11 — Records-derived contracts, generations, and release profile | Planned | M1-7, M1-10 | Private derivatives, generation checks, numeric profile |
...
Status: Planned. Depends on M1-7 and M1-10.

Governing references: HLD §§4, 5.1 side artifacts, 6.6 dashboard/derived
contracts, 6.10.4 reader authority, 6.10.6 shard/generation obligations, and
§9.2 capacity envelope; `REQ-REC-5..6`, `REQ-DASH-1..5`, `REQ-SEC-1..3`,
and `REQ-OPS-3`.
...
is deterministic. The assembler receives the exact already-created M1-2
...
Negative cases cover stale generations, missing/extra/oversize shards, digest
