...
fold, user shard, marker, fence, derived state, status detail, and reader
authority. They decode and validate; they compute no update and no decision.
...
accept every closed plaintext this milestone defines and reject unknown,
missing, and mistyped members in each, without computing any update.
