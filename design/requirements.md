...
Status: Locked
Date: 22 August 2026
Revision: 9 — reconciles the bounded public message for overlapping project
scope with the general disclosure rules; see section 20.
...
- refusal to bind a repository or organization-wide selector that would place
  ...
  recovery after a missed lifecycle event through reconciliation; continued
  operation of unaffected repositories; and documentation that independent
  domains cannot enforce
  global uniqueness;
