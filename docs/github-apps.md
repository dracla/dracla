...
`https://dracla.cli.dev/p/<slug>` for a default project and
`https://dracla.cli.dev/p/<owner>/<slug>` for an explicit same-owner project —
in badges, check output, and pull request comments.
